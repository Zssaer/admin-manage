	...
	<div class="login-container">
		...
		<div class="login-content" :class="{ 'login-content-mobile': tabsActiveName === 'mobile' }">
			<div class="login-content-main">
				...
				<!-- <div class="mt10">
					<el-button type="text" size="small">第三方登陆</el-button>
					<el-button type="text" size="small">友情链接</el-button>
				</div> -->
			</div>
		</div>
		<div class="login-copyright">
			<div class="mb5 login-copyright-company">版权所有：成都市悠然阿尔法科技有限公司</div>
			<div class="login-copyright-msg">蜀ICP备05006379号-6I川公网安备 51019002000280号</div>
		</div>
	</div>
</template>
...
import Account from '../login/component/account.vue';
import Mobile from '../login/component/mobile.vue';
export default {
	name: 'login',
