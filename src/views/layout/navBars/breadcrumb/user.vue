<template>
  ...
  >
    <div class="layout-navbars-breadcrumb-user-icon" @click="onSearchClick">
      <i class="el-icon-search" title="菜单搜索" :style="{ color: topBarTextColor }"></i>
    </div>
    <div class="layout-navbars-breadcrumb-user-icon" @click="onSettingClick">
      <i class="el-icon-s-open" title="主题设置" :style="{ color: topBarTextColor }"></i>
    </div>
    <div class="layout-navbars-breadcrumb-user-icon">
      ...
      >
        <template #reference>
          ...
          >
            <i class="el-icon-bell" title="消息" :style="{ color: topBarTextColor }"></i>
          </el-badge>
        </template>
    ...
    >
      <span class="layout-navbars-breadcrumb-user-link">
        <img
          :src="getUserInfos.accessImage ? '222.png' : '/src/assets/user.png' "
          class="layout-navbars-breadcrumb-user-link-photo mr5"
        />
        <span :style="{ color: topBarTextColor }">
        {{ getUserInfos.loginName === "" ? "test" : getUserInfos.loginName }}
        </span>
        <i class="el-icon-caret-bottom" :style="{ color: topBarTextColor }"></i>
      </span>
      <template #dropdown>
        <el-dropdown-menu>
          <el-dropdown-item command="/home">首页</el-dropdown-item>
          <el-dropdown-item command="/selfMag/passwordmag"
